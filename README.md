<!-- 🌟 Ultimate 3D GitHub README for Wilson Campos | WilTsuo -->
...
### 👋 Sobre Mim  
Sou um desenvolvedor brasileiro nascido em **São José dos Campos**, com uma trajetória internacional que combina **experiência industrial** e **habilidades em desenvolvimento de software**.  
Após **6 anos morando e trabalhando no Japão**, sigo minha paixão por tecnologia estudando no **Politécnico de Leiria (Portugal)**.

---

### 🏭 **Experiência Profissional**
- 🏍️ **Yamaha Motor Corporation (Japão)** — Especialista em manufatura de peças para motos e barcos  
...
📘 **Programação de Sistemas de Informação** — 2º Ano, 1º Semestre  
...
- 🖌️ **Canva** — Design visual e identidade digital  
- 📋 **Jira** — Gestão de projetos e tarefas  
- 🚀 **Agile / Scrum** — Experiência em metodologias ágeis  
...
### 🎯 Atualmente  
🔍 **À procura de estágio** e novas oportunidades para crescer na área de **desenvolvimento de software**.  

📫 **Contato:** [wilcampos2003@gmail.com](mailto:wilcampos2003@gmail.com)
...
### 👋 About Me  
I’m a Brazilian developer born in **São José dos Campos**, with an international background blending **industrial experience** and **software development skills**.  
After **6 years living and working in Japan**, I’m now pursuing my passion for technology at **Politécnico de Leiria (Portugal)**.

---

### 🏭 Professional Experience
- 🏍️ **Yamaha Motor Corporation (Japan)** — Manufacturing specialist for motorcycle and boat parts  
...
- 🖌️ **Canva** — Visual design and branding  
- 📋 **Jira** — Agile project management  
- 🚀 **Scrum Methodology** — Team collaboration and sprint planning  
...
### 🎯 Currently  
🔍 **Actively seeking internship opportunities** to grow and contribute in **software development**.  

📫 **Contact:** [wilcampos2003@gmail.com](mailto:wilcampos2003@gmail.com)
...
### 👋 自己紹介  
**サンジョゼドスカンポス**生まれのブラジル人開発者です。産業経験とソフトウェア開発スキルを組み合わせた国際的な背景を持っています。  
**日本で6年間**生活し働いた後、現在は**ポリテクニコ・デ・レイリア（ポルトガル）**でテクノロジーへの情熱を追求しています。

---

### 🏭 職務経験
- 🏍️ **ヤマハ発動機株式会社（日本）** — オートバイおよびボート部品製造スペシャリスト  
- 💻 **ASTI** — 電子基板のはんだ付け技術者  
...
- HTML、CSS、XML  
- Yii2 Framework / PHP Active Record / Entity Framework / ASP.NET Core  
- 🎨 Figma / 🖌️ Canva / 📋 Jira  
- 🚀 アジャイル・スクラム開発経験  
- 📱 Android アプリ開発  
